...
.開始する前に
新しいデータベースを作成する前に、以下の前提条件をすべて満たしてください。

* *認証情報と権限*：Workload Factoryで新しいデータベースを作成するには、link:https://docs.netapp.com/us-en/workload-setup-admin/add-credentials.html["AWSアカウントの認証情報と_操作および修復_権限"^]が必要です。
+
