...
---
= NetApp Workload Factory for Databasesを使用してMicrosoft SQL Serverワークロードを保護します
:allow-uri-read: 
:icons: font
:imagesdir: ./media/
...
== Microsoft SQL Server リソースの編集保護

NetApp Backup and Recoveryですでに保護されている Microsoft SQL Server インスタンスおよびデータベースの保護を編集できます。保護を編集すると、保護された SQL Server インスタンスの保護ポリシーまたはスケジュールを変更できます。
...
. インベントリで、エンジンの種類として *Microsoft SQL Server* を選択します。
. *データベース*タブを選択します。
. 保護を編集するデータベースを見つけて、メニューから*保護の編集*を選択します。
+
NetApp Consoleのバックアップとリカバリにリダイレクトされ、保護ポリシーまたはスケジュールを変更できます。
